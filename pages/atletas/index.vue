  ...
  <div class="space-y-4 animate-fade-in">
    ...
    <div class="flex items-end justify-between gap-4 flex-wrap">
      ...
      <div class="flex items-center gap-2">
        <!-- Toggle vista -->
        <div data-tour="atletas-vista" class="inline-flex rounded-lg border border-slate-200 dark:border-white/[0.10] bg-white dark:bg-surface-elevated-dark p-0.5">
          <button
    ...
    <!-- ── Filtros ──────────────────────────────────────────── -->
    <div data-tour="atletas-filtros" class="bg-white dark:bg-surface-elevated-dark rounded-xl border border-slate-200 dark:border-white/[0.10] p-3">
    ...
    <!-- Grid -->
    <div v-else-if="vista === 'grid'" data-tour="atletas-lista" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
      <AtletasCard
...
const tour = useGuidedTour('athletto_tour_atletas_done', [
  { tourId: 'atletas-novo', title: 'Novo atleta', description: 'Cadastre um atleta na hora, ou envie um link de cadastro pra o responsável preencher pelo celular.' },
  { tourId: 'atletas-filtros', title: 'Buscar e filtrar', description: 'Busque por nome, apelido ou CPF, e filtre por turma, status ou saúde pra achar rápido quem procura.' },
  { tourId: 'atletas-vista', title: 'Grid ou Tabela', description: 'Alterne entre cards visuais (Grid) e uma lista mais compacta (Tabela) — o que for mais fácil pra você.' },
  { tourId: 'atletas-lista', title: 'Ver detalhes', description: 'Clique em qualquer atleta pra abrir o perfil completo: turmas, frequência e financeiro dele.' },
])
