  ...
  <div class="space-y-4 animate-fade-in">
    ...
    <div class="flex items-end justify-between gap-4 flex-wrap">
      ...
      <div class="flex items-center gap-2">
        <!-- Toggle vista -->
        <div data-tour="cal-vista" class="inline-flex rounded-lg border border-slate-200 dark:border-white/[0.10] bg-white dark:bg-surface-elevated-dark p-0.5">
          <button
    ...
    <!-- Barra de navegação -->
    <div data-tour="cal-nav" class="bg-white dark:bg-surface-elevated-dark rounded-xl border border-slate-200 dark:border-white/[0.10] p-3 flex items-center gap-3">
...
const tour = useGuidedTour('athletto_tour_calendario_done', [
  { tourId: 'cal-vista', title: 'Semana ou Mês', description: 'Alterne entre a visão detalhada da semana e a visão geral do mês.' },
  { tourId: 'cal-novo', title: 'Novo evento', description: 'Crie jogos, reuniões e outros eventos manuais. Os treinos das turmas já aparecem aqui sozinhos, marcados como "auto".' },
  { tourId: 'cal-nav', title: 'Navegar entre datas', description: 'Use as setas pra ir e voltar, ou o botão "Hoje" pra voltar rápido pra data atual.' },
])
