  ...
  <div class="space-y-4 animate-fade-in">
    ...
    <div class="card-base p-3">
      <div class="flex flex-wrap items-center gap-2">
        ...
        <select v-model="filtroStatus" class="px-3 py-2 rounded-lg border border-slate-200 dark:border-white/[0.10] bg-white dark:bg-surface-canvas-dark text-sm font-medium focus:outline-none">
        ...
        <select v-model="filtroPlano" class="px-3 py-2 rounded-lg border border-slate-200 dark:border-white/[0.10] bg-white dark:bg-surface-canvas-dark text-sm font-medium focus:outline-none">
        ...
        <table class="min-w-full text-sm">
          <thead class="bg-slate-50 dark:bg-white/[0.02] border-b border-slate-200 dark:border-white/[0.06]">
            <tr>
              ...
              <th class="text-left px-3 py-3 font-semibold text-slate-600 dark:text-slate-400">Trial / Próxima cobrança</th>
              <th class="text-right px-5 py-3 font-semibold text-slate-600 dark:text-slate-400">MRR</th>
              <th class="px-3 py-3"/>
            </tr>
          </thead>
          <tbody class="divide-y divide-slate-100 dark:divide-white/[0.06]">
            <tr v-for="c in clubesFiltrados" :key="c.id" class="hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-colors">
              <td class="px-5 py-3">
