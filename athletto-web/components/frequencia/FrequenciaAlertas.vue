  ...
  <div class="space-y-4">
    ...
    <ul v-else class="space-y-2">
      ...
      >
        <UiAvatar
          :nome="al.atleta?.nome ?? '?'"
          :src="al.atleta?.foto_url"
          size="md"
          class="rounded-full ring-2 ring-red-400/70"
        />
...
import { formatDate, gerarLinkWhatsApp, gerarMensagemEvasao } from '~/utils/format'
