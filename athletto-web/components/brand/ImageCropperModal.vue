        ...
        >
          ...
          <div class="flex-1 overflow-y-auto">
            ...
            <div v-else class="bg-slate-900">
              ...
              />
              <div class="flex items-center justify-between px-6 py-3 bg-slate-800/80 text-xs text-white/70">
                <span>Arraste para reposicionar. Use os cantos para ajustar o zoom.</span>
                <button
                  type="button"
