  ...
  >
    ...
    >
      <div class="shrink-0 w-9 h-9 flex items-center justify-center">
        <svg viewBox="0 0 36 40" fill="none" class="w-9 h-9">
          <path d="M18 0L0 10v20l18 10 18-10V10L18 0z" fill="#ccff00"/>
          <path d="M18 8L7 14v12l11 6 11-6V14L18 8z" fill="#1a2fe8"/>
          <text x="18" y="27" text-anchor="middle" font-family="Inter" font-weight="800" font-size="13" fill="#ccff00">A</text>
        </svg>
      </div>
