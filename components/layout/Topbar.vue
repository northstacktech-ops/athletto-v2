...
// Fonte da verdade: o estado reativo `clube` (atualiza ao salvar nas
// Configurações). Antes priorizávamos um cache legado em localStorage
// (`athletto_clube_data`) que ninguém mais escreve — ele "congelava" o nome
// antigo no topo e causava hydration mismatch.
