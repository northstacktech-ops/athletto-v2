...
const planejamentoId = computed(() => (props.caixinha as any).planejamento_id as string | undefined)
const planejamentoValor = computed(() => Number((props.caixinha as any).planejamentos?.valor ?? 0))
...
const planejamentoInfo = computed<PlanejamentoInfo | undefined>(() => (props.caixinha as any).planejamentos)
