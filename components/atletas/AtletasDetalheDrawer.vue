      ...
      >
        ...
        <div class="px-6 pt-5 pb-4 border-b border-slate-100 dark:border-white/[0.06]">
          <div class="flex items-start gap-4">
            <UiAvatar
              :src="fotoOverride ?? atleta.foto_url"
              :nome="atleta.nome"
...
// Upload de foto é imediato dentro do modal (não espera o "Salvar") — se o
// usuário fechar sem salvar o resto, a foto ainda precisa refletir na hora
// aqui no drawer. Não emite 'atualizado' aqui pra não fechar o drawer/modal
// no meio da edição — a lista por trás sincroniza no próximo carregar().
const fotoOverride = ref<string | null>(null)
function onFotoAtualizada(url: string) {
  fotoOverride.value = url
}
</script>
