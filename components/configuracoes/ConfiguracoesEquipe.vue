      ...
      <div class="flex items-center gap-4 flex-wrap">
        ...
        <div class="flex-1 min-w-[160px] space-y-1.5">
          ...
          <div class="flex items-center gap-2 flex-wrap">
            <span class="px-2 py-0.5 rounded-md text-xs font-bold" :class="planoBadge">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            <div class="flex items-stretch">
              <span class="inline-flex items-center px-2.5 rounded-l-lg border border-r-0 border-slate-200 dark:border-white/[0.10] bg-slate-50 dark:bg-white/[0.02] text-xs text-slate-500">athletto.com.br/cadastro/</span>
          ...
          <div>
            ...
            <select v-model="form.modalidade" class="form-input">
...
import { nomePlano, type Clube } from '~/types'

// Mesma taxonomia usada nos ícones de turma (useTurmaVisual) — mantém
// modalidade do clube e modalidade das turmas no mesmo vocabulário, já que
// esse campo vira dado estruturado (filtro, marketplace de clubes etc.).
const MODALIDADES = [
  'Futebol', 'Futsal', 'Futebol Americano', 'Flag Football', 'Vôlei', 'Basquete',
  'Handebol', 'Natação', 'Tênis', 'Corrida', 'Luta', 'Academia', 'Ciclismo', 'Outro',
]
